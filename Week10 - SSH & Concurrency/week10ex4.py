"""
4. Create a new program that completes same task as Ex3b except using multiple processes (i.e. a 'ProcessPoolExecutor')
"""
...
def main():
    ...
    max_threads = 4
    # Create instance of PrcoessPoolExecutor object and pass in max_thread no
